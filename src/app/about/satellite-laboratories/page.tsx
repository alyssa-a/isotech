...
export default function SatelliteLaboratories() {
    ...
    return (
        <Subpage breadcrumbs={breadcrumbs}>
            ...
            <p className="clearfix">For further information, including pricing for analyses and sampling products, <Link href="mailto:bashar.qassim@stratumreservoir.com">contact Stratum Reservoir - Calgary</Link>.</p>
            ...
            <p>Isotech&lsquo;s satellite laboratory in Trinidad opened in the fall of 2018. It is positioned to provide service to South America and the Gulf of Mexico.</p>
