...
export default function Cylinders() {
    ...
    return (
        ...
        <Subpage breadcrumbs={breadcrumbs}>
            ...
            <p className="mt-4"><Link className="button download" href="/files/Stainless_Steel_Cylinders_Sampling_Instructions.pdf">Stainless Steel Gas Cylinders Sampling Instructions (PDF)</Link></p>
            ...
            <p className="mt-4"><Link className="button download" href="/files/LP_Cylinders_Sampling_Instructions.pdf">LP Gas Cylinders Sampling Instructions (PDF)</Link></p>
